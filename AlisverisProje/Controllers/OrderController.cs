...
namespace AlisverisProje.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,ProductId,OrderDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,ProductId,OrderDate")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
