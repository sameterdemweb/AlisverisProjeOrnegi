...
namespace AlisverisProje.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,City,Country")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,City,Country")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
